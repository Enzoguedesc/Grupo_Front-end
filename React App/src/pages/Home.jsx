      ...
      <div className="filtro">
        ...
        <div className="container_filtro">
          ...
          <select className="filtro-container" onChange={ (e) => {if(params.get('courses') === null){params.append('courses', e.target.value);}else{params.set('courses', e.target.value);} setParams(params)}}>
              <option value="Direito" >{t("law")}</option>
              <option value="Tech" >Tech</option>
              <option value="ADM" >ADM</option>
              <option value="Arquitetura" >{t("arquitecture")}</option>
          ...
          <div className="container_filtro">
            ...
            <select className="filtro-container" onChange={ (e) => {if(params.get('semester') === null){params.append('semester', e.target.value);}else{params.set('semester', e.target.value);} setParams(params)}}>
                <option value="1º-Período" >1º {t("semester")}</option>
                <option value="2º-Período" >2º {t("semester")}</option>
                <option value="3º-Período" >3º {t("semester")}</option>
                <option value="4º-Período" >4º {t("semester")}</option>
                <option value="5º-Período" >5º {t("semester")}</option>
                <option value="6º-Período" >6º {t("semester")}</option>
                <option value="7º-Período" >7º {t("semester")}</option>
                <option value="8º-Período" >8º {t("semester")}</option>
            </select>
          </div>
